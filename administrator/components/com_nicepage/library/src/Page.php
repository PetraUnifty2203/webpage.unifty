...
use \JFactory, \JURI, \JPluginHelper, \JEventDispatcher, \JHtml, \JRegistry;
...
class Page
{
    ...
    public function appendOpenGraphTags() {
        ...
        if ($siteDisableOpenGraph || $this->_props['disableOpenGraph']) {
            return;
        }
        ...
        $seoTags['og:url'] = array('tag' => 'meta', 'property' => 'og:url', 'content' => JUri::getInstance()->toString());
...
HTML;
    ...
    public function prepareProps($props)
    {
        ...
        $props['disableOpenGraph']  = isset($props['disableOpenGraph']) && $props['disableOpenGraph'] == 'true' ? true : false;
