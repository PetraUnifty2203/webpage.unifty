...
@media (max-width: 979px) {
	...
	<div class="installer-right">
		<h2>RSPageBuilder! v1.0.38 Changelog</h2>
		<ul class="version-history">
			<li><span class="version-fixed">Fix</span> YouTube Video elements did not work properly due to changes made in YouTube IFrame Player API.</li>
		</ul>
