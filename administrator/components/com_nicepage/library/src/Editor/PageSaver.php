...
class PageSaver
{
    ...
    public function saveData()
    {
        ...
        $disableOpenGraph     = isset($this->_opt['disableOpenGraph']) ? filter_var($this->_opt['disableOpenGraph'], FILTER_VALIDATE_BOOLEAN) : false;
        ...
        $props = array(
            ...
            'disableOpenGraph' => $disableOpenGraph,
